...
class CalculatorCobSvIfFactory {
 public:
  ...
  virtual void releaseHandler(CalculatorCobSvIf* /* handler */) = 0;
};
...
class CalculatorCobSvIfSingletonFactory : virtual public CalculatorCobSvIfFactory {
 public:
  ...
  virtual void releaseHandler(CalculatorCobSvIf* /* handler */) {}

 protected:
  boost::shared_ptr<CalculatorCobSvIf> iface_;
};

class CalculatorCobSvNull : virtual public CalculatorCobSvIf {
 public:
...
class CalculatorAsyncProcessor : public ::apache::thrift::async::TAsyncDispatchProcessor {
 protected:
  boost::shared_ptr<CalculatorCobSvIf> iface_;
